...
return new class extends Migration
{
    ...
    {
        Schema::create('traveler_profiles', function (Blueprint $t) {
            $t->id();
        ...
        Schema::create('reward_entries', function (Blueprint $t) {
            $t->id();
            $t->foreignId('user_id')->constrained();
        ...
        Schema::create('affiliates', function (Blueprint $t) {
            ...
            $t->unsignedInteger('commission_bps')->default(0);
