                ...
                <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
                    <div class="relative rounded-2xl sm:rounded-3xl md:rounded-[36px] overflow-hidden min-h-[380px] sm:min-h-[440px] md:min-h-[480px] flex items-center justify-center text-center shadow-2xl">
                        ...
                        <div class="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 pt-6 sm:pt-10 pb-24 sm:pb-28 md:pb-36 text-white">
                            <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-orange-500/25 border border-orange-400/40 text-orange-300 text-xs font-bold mb-4 backdrop-blur-xs">
                    ...
                    <!-- Floating Search Bar -->
                    <div class="max-w-4xl mx-auto -mt-16 sm:-mt-20 md:-mt-24 relative z-20 px-1 sm:px-4">
                        <div class="bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-100 p-4 backdrop-blur-xs">
                            <div class="flex flex-col sm:flex-row items-center gap-3">
                                <div class="flex-1 w-full bg-gray-50 border border-gray-200 rounded-xl px-3.5 py-2 flex items-center gap-2">
