            ...
            <section aria-labelledby="blog-title" class="mx-auto max-w-[1180px]">
                ...
                <div class="grid gap-5 lg:grid-cols-[1.65fr_1fr]">
                    ...
                    <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
                        <article v-for="(article, index) in supportingArticles" :key="article.id" class="group overflow-hidden rounded-2xl border border-[#e4edf7] bg-white shadow-[0_4px_16px_rgba(23,75,120,0.04)] transition-shadow hover:shadow-[0_8px_24px_rgba(23,75,120,0.1)]">
                            <button type="button" class="flex h-full w-full flex-col text-left focus-visible:outline-2 focus-visible:-outline-offset-4 focus-visible:outline-[#3E7BEF] lg:flex-row" @click="travelBlog?.readArticle(article)">
