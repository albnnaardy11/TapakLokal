        ...
        <main class="mx-auto max-w-[1220px] px-3 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8">
            <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_330px] lg:items-start">
                <section class="min-w-0">
                    <h1 class="max-w-3xl break-words text-2xl font-extrabold leading-[1.1] tracking-tight text-[#173b70] sm:text-4xl sm:leading-[1.05]">{{ detail.title }}<span class="mt-0.5 block">{{ detail.startPoint }} <span class="whitespace-nowrap text-[#1677e8]">{{ detail.duration }}</span></span></h1>
                    <p class="mt-3 max-w-2xl text-sm leading-6 text-slate-600">{{ detail.subtitle }}</p>

                    <div class="mt-5 grid gap-2.5 sm:mt-6 sm:gap-3 lg:grid-cols-[minmax(0,1fr)_132px]">
                        <div class="relative h-64 overflow-hidden rounded-2xl bg-slate-200 sm:h-[390px]">
