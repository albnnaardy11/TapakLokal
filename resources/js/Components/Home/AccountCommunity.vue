...
<template>
    <section class="text-[#26364d]">
        <h2 :class="['OT & OP Favorit', 'Daftar Wisatawan'].includes(section) ? 'text-sm font-extrabold text-[#183660]' : 'text-xl font-extrabold tracking-tight'">{{ section }}</h2>
