...
<template>
    <div class="mt-4 space-y-4">
        ...
        <form class="overflow-hidden rounded-2xl border border-[#e1eaf5] bg-white shadow-[0_4px_20px_rgba(23,75,120,0.04)]" @submit.prevent="submit">
            <div class="flex items-center gap-3 border-b border-slate-100 px-4 py-3"><span class="grid size-10 shrink-0 place-items-center rounded-xl bg-[#edf5ff] text-[#3E7BEF]"><LockKeyhole class="size-5" /></span><div><h3 class="text-xs font-bold text-[#183660]">Ubah kata sandi</h3><p class="mt-1 text-[11px] leading-5 text-slate-400">Gunakan kata sandi berbeda dari akun lain untuk menjaga keamananmu.</p></div></div>
