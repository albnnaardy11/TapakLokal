...
const props = defineProps({ trip: Object, bookingKey: String, reviews: Array });
const page = usePage();
...
<template>
    ...
    <div class="min-h-screen bg-[#f6f8fb] text-[#17375f]"><main class="mx-auto max-w-[1180px] px-5 py-8 sm:px-8">
        ...
        <div class="mt-7 grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
