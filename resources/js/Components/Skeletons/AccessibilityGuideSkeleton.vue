<template>
    <div class="min-h-screen bg-[#f8fafc] font-sans">
        <!-- Skeleton Navbar -->
        <div class="h-[58px] lg:h-[70px] border-b border-slate-100 bg-white/95 px-5 sm:px-8">
        ...
        <main class="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8 pb-20 sm:pb-28 pt-6 sm:pt-8 lg:pt-12 space-y-12 sm:space-y-16">
            <!-- Hero Section Skeleton (2-column 1:1) -->
            <section class="rounded-[28px] sm:rounded-[36px] lg:rounded-[40px] border border-[#dce8f8] bg-[#f8fbff] p-6 sm:p-9 md:p-11 lg:p-12 xl:p-14 shadow-xs">
            ...
            <section class="rounded-[24px] sm:rounded-[28px] border border-[#d8eafb] bg-[#edf5fe] p-5 sm:p-8 lg:p-10">
                <div class="grid gap-6 sm:gap-8 lg:grid-cols-[1fr_2.4fr] lg:items-center">
                    ...
                    <div class="grid gap-4 grid-cols-1 sm:grid-cols-3 sm:gap-5">
                        <div v-for="n in 3" :key="n" class="rounded-[20px] sm:rounded-[24px] border border-[#e2eaf4] bg-white p-5 sm:p-6 space-y-3 text-center min-h-[190px] flex flex-col items-center justify-center">
            ...
            <!-- Section 2 Skeleton: 12 Fitur (4-cols) -->
            <section class="space-y-6">
                ...
                <div class="grid gap-3.5 sm:gap-4 lg:gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                    <div v-for="n in 12" :key="n" class="rounded-[20px] sm:rounded-[22px] border border-[#e4edf7] bg-white p-5 space-y-4">
            ...
            <section class="rounded-[24px] sm:rounded-[28px] border border-[#d8eafb] bg-[#edf5fe] p-6 lg:p-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="rounded-[20px] sm:rounded-[22px] bg-white p-5 sm:p-6 space-y-3">
                        <div v-for="n in 5" :key="n" class="flex items-center gap-3 py-1.5">
            ...
            <section class="space-y-6">
                ...
                <div class="grid gap-4 sm:gap-5 grid-cols-1 md:grid-cols-3">
                    <div v-for="n in 3" :key="n" class="rounded-[20px] sm:rounded-[24px] border border-[#e2eaf4] bg-white p-6 space-y-4">
